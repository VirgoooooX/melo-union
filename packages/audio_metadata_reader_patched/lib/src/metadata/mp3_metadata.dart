...
class Mp3Metadata extends ParserTag {
  ...
  List<String> leadPerformers = []; // TPE1 multi-value (ID3v2.4)
  String? bandOrOrchestra; // TPE2
  List<String> bandsOrOrchestras = []; // TPE2 multi-value (ID3v2.4)
...
// 4.8 SYTC [#sec4.8 Synchronized tempo codes]
  ...
  String toString() {
    return 'Mp3Metadata(\n'
        ...
        '  leadPerformers: $leadPerformers,\n'
        '  bandOrOrchestra: $bandOrOrchestra,\n'
        '  bandsOrOrchestras: $bandsOrOrchestras,\n'
        '  conductor: $conductor,\n'
