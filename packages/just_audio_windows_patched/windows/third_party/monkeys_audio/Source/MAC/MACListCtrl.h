...
public:
    CMACListCtrl();
    virtual ~CMACListCtrl() APE_OVERRIDE;
...
protected:
    ...
    afx_msg BOOL OnNotify(WPARAM wParam, LPARAM lParam, LRESULT * pResult) APE_OVERRIDE;
    ...
    static int CompareStatic(const void * pOne, const void * pTwo);
    ...
    // other data
    CMACDlg * m_pParent;
    int m_nCompareColumn;
    int m_nCompareOrder;

    // statics
    static CMACListCtrl * s_pThis;
};
